...
safe_VkIndirectExecutionSetInfoEXT::safe_VkIndirectExecutionSetInfoEXT(const VkIndirectExecutionSetInfoEXT* in_struct,
                                                                       PNextCopyState*) {
    initialize(in_struct);
}

safe_VkIndirectExecutionSetInfoEXT::safe_VkIndirectExecutionSetInfoEXT() : pPipelineInfo(nullptr), pShaderInfo(nullptr) {}

safe_VkIndirectExecutionSetInfoEXT::safe_VkIndirectExecutionSetInfoEXT(const safe_VkIndirectExecutionSetInfoEXT& copy_src) {
    pPipelineInfo = nullptr;
    pShaderInfo = nullptr;
    if (copy_src.pPipelineInfo) pPipelineInfo = new safe_VkIndirectExecutionSetPipelineInfoEXT(*copy_src.pPipelineInfo);
    if (copy_src.pShaderInfo) pShaderInfo = new safe_VkIndirectExecutionSetShaderInfoEXT(*copy_src.pShaderInfo);
}

safe_VkIndirectExecutionSetInfoEXT& safe_VkIndirectExecutionSetInfoEXT::operator=(
    const safe_VkIndirectExecutionSetInfoEXT& copy_src) {
    if (&copy_src == this) return *this;

    if (pPipelineInfo) delete pPipelineInfo;
    if (pShaderInfo) delete pShaderInfo;
...
safe_VkIndirectExecutionSetInfoEXT::~safe_VkIndirectExecutionSetInfoEXT() {
    if (pPipelineInfo) delete pPipelineInfo;
    if (pShaderInfo) delete pShaderInfo;
}

void safe_VkIndirectExecutionSetInfoEXT::initialize(const VkIndirectExecutionSetInfoEXT* in_struct,
                                                    [[maybe_unused]] PNextCopyState* copy_state) {
    if (pPipelineInfo) delete pPipelineInfo;
    if (pShaderInfo) delete pShaderInfo;
    pPipelineInfo = nullptr;
    pShaderInfo = nullptr;
    if (in_struct->pPipelineInfo) pPipelineInfo = new safe_VkIndirectExecutionSetPipelineInfoEXT(in_struct->pPipelineInfo);
    if (in_struct->pShaderInfo) pShaderInfo = new safe_VkIndirectExecutionSetShaderInfoEXT(in_struct->pShaderInfo);
}

void safe_VkIndirectExecutionSetInfoEXT::initialize(const safe_VkIndirectExecutionSetInfoEXT* copy_src,
                                                    [[maybe_unused]] PNextCopyState* copy_state) {
    pPipelineInfo = nullptr;
    pShaderInfo = nullptr;
    if (copy_src->pPipelineInfo) pPipelineInfo = new safe_VkIndirectExecutionSetPipelineInfoEXT(*copy_src->pPipelineInfo);
...
safe_VkIndirectExecutionSetCreateInfoEXT::safe_VkIndirectExecutionSetCreateInfoEXT()
    : sType(VK_STRUCTURE_TYPE_INDIRECT_EXECUTION_SET_CREATE_INFO_EXT), pNext(nullptr), type() {}
...
safe_VkIndirectCommandsTokenDataEXT::safe_VkIndirectCommandsTokenDataEXT(const VkIndirectCommandsTokenDataEXT* in_struct,
                                                                         PNextCopyState*) {
    initialize(in_struct);
}

safe_VkIndirectCommandsTokenDataEXT::safe_VkIndirectCommandsTokenDataEXT()
    : pPushConstant(nullptr), pVertexBuffer(nullptr), pIndexBuffer(nullptr), pExecutionSet(nullptr) {}

safe_VkIndirectCommandsTokenDataEXT::safe_VkIndirectCommandsTokenDataEXT(const safe_VkIndirectCommandsTokenDataEXT& copy_src) {
    pPushConstant = nullptr;
    pVertexBuffer = nullptr;
    pIndexBuffer = nullptr;
    pExecutionSet = nullptr;

    if (copy_src.pPushConstant) {
        pPushConstant = new VkIndirectCommandsPushConstantTokenEXT(*copy_src.pPushConstant);
    }

    if (copy_src.pVertexBuffer) {
        pVertexBuffer = new VkIndirectCommandsVertexBufferTokenEXT(*copy_src.pVertexBuffer);
    }

    if (copy_src.pIndexBuffer) {
        pIndexBuffer = new VkIndirectCommandsIndexBufferTokenEXT(*copy_src.pIndexBuffer);
    }

    if (copy_src.pExecutionSet) {
        pExecutionSet = new VkIndirectCommandsExecutionSetTokenEXT(*copy_src.pExecutionSet);
    }
}

safe_VkIndirectCommandsTokenDataEXT& safe_VkIndirectCommandsTokenDataEXT::operator=(
    const safe_VkIndirectCommandsTokenDataEXT& copy_src) {
    if (&copy_src == this) return *this;

    if (pPushConstant) delete pPushConstant;
    if (pVertexBuffer) delete pVertexBuffer;
    if (pIndexBuffer) delete pIndexBuffer;
    if (pExecutionSet) delete pExecutionSet;
...
void safe_VkIndirectCommandsTokenDataEXT::initialize(const VkIndirectCommandsTokenDataEXT* in_struct,
                                                     [[maybe_unused]] PNextCopyState* copy_state) {
    if (pPushConstant) delete pPushConstant;
    if (pVertexBuffer) delete pVertexBuffer;
    if (pIndexBuffer) delete pIndexBuffer;
    ...
    if (in_struct->pPushConstant) {
        pPushConstant = new VkIndirectCommandsPushConstantTokenEXT(*in_struct->pPushConstant);
    }

    if (in_struct->pVertexBuffer) {
        pVertexBuffer = new VkIndirectCommandsVertexBufferTokenEXT(*in_struct->pVertexBuffer);
    }

    if (in_struct->pIndexBuffer) {
        pIndexBuffer = new VkIndirectCommandsIndexBufferTokenEXT(*in_struct->pIndexBuffer);
    }

    if (in_struct->pExecutionSet) {
        pExecutionSet = new VkIndirectCommandsExecutionSetTokenEXT(*in_struct->pExecutionSet);
    }
}

void safe_VkIndirectCommandsTokenDataEXT::initialize(const safe_VkIndirectCommandsTokenDataEXT* copy_src,
                                                     [[maybe_unused]] PNextCopyState* copy_state) {
    pPushConstant = nullptr;
    pVertexBuffer = nullptr;
    pIndexBuffer = nullptr;
...
safe_VkIndirectCommandsLayoutTokenEXT::safe_VkIndirectCommandsLayoutTokenEXT()
    : sType(VK_STRUCTURE_TYPE_INDIRECT_COMMANDS_LAYOUT_TOKEN_EXT), pNext(nullptr), type(), offset() {}
